    ...
    with open(exlog, 'w') as f:
        for idx, item in enumerate(events):
            line = "  ".join([item, ff(pPs[idx]), ff(pSs[idx]),
                              ...
                              ff(P_ws[idx]), ff(S_ws[idx]), ff(dists[idx]), "\n"])
            f.writelines(line)
...
if __name__ == '__main__':
    ...
    single_sta(staid="YN.PAS", datadir="./Data/Crust100", 
               exlog="./YN.PAS.Crust100.POL", Pwin=(0, 5), Swin=(0, 5), noise_win=(5,10), 
